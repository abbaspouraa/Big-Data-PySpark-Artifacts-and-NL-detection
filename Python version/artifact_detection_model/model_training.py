...
def run_ml_artifact_training(df_train, df_test, clf, model_output_path=''):
    ...
    if model_output_path:
        ...
        with open(model_output_path + 'wrongly_identified_as_artifact.json', 'w', encoding="utf-8") as fd:
            fd.write('\n\n'.join(wrongly_identified_as_artifact))
        with open(model_output_path + 'wrongly_identified_as_text.json', 'w', encoding="utf-8") as fd:
